  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        meta: { title: '章节与内容', icon: 'List' }
      },
      {
        path: 'course/plan',
        name: 'CoursePlan',
        component: () => import('@/views/course/PlanList.vue'),
        meta: { title: '教学计划', icon: 'Calendar' }
      },
      // 课程实验计划管理
      {
        path: 'experiment/plan',
        name: 'ExperimentPlan',
        component: () => import('@/views/experiment/PlanList.vue'),
        meta: { title: '实验计划', icon: 'Cpu' }
      },
      // 实训计划管理
      {
        path: 'training/plan',
        ...
        meta: { title: '实训计划', icon: 'Promotion' }
      },
      {
      ...
      // 资源管理
      {
        ...
        component: () => import('@/views/resource/CategoryList.vue'),
        meta: { title: '资源分类', icon: 'FolderOpened' }
      },
      {
        path: 'resource/list',
        name: 'ResourceList',
        component: () => import('@/views/resource/ResourceList.vue'),
        meta: { title: '资源列表', icon: 'Files' }
      },
      // 网站门户
      {
        path: 'portal/banner',
        name: 'PortalBanner',
        component: () => import('@/views/portal/BannerList.vue'),
        meta: { title: '轮播图', icon: 'Picture' }
      },
      {
        path: 'portal/notice',
        name: 'PortalNotice',
        component: () => import('@/views/portal/NoticeList.vue'),
