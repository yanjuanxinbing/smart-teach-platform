  ...
  <div class="app-container">
    <el-card>
      <div class="toolbar">
        ...
        <el-button type="primary" :icon="Plus" @click="openForm()">新增新闻资讯</el-button>
      </div>
    ...
    <el-dialog v-model="dialogVisible" :title="form.id ? '编辑新闻资讯' : '新增新闻资讯'" width="720px">
      <el-form ref="formRef" :model="form" :rules="rules" label-width="100px">
        <el-form-item label="标题" prop="title"><el-input v-model="form.title" placeholder="请输入新闻标题" /></el-form-item>
        ...
        <el-form-item label="正文" prop="content">
          <el-input v-model="form.content" type="textarea" :rows="10" placeholder="支持纯文本/HTML 片段" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const rules = {
  ...
  content: [{ required: true, message: '请输入新闻正文' }]
}
