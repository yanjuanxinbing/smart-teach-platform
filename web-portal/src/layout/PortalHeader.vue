  ...
  <header class="ph" :class="{ 'ph--scrolled': scrolled, 'ph--open': menuOpen }">
    <div class="container ph__inner">
      ...
      <nav class="ph__nav" :aria-expanded="menuOpen ? 'true' : 'false'">
        ...
        <a class="ph__link ph__link--cta" href="http://localhost:8081" target="_blank" rel="noopener">
...
.ph__link--cta { color: var(--ink); padding-left: 14px; border-left: 1px solid var(--line); align-items: center; }
...
@media (max-width: 880px) {
  ...
  .ph__link--cta { border-left: none; padding-left: 0; margin-top: var(--s-3); }
}
